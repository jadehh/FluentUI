...
public:
     ...
     */
    Q_INVOKABLE void setTimeFormat(const QString &format) const noexcept;
     ...
     */
    Q_INVOKABLE void addCurrentTimeValue(const QString& name, double value) const noexcept;
     ...
     */
    Q_INVOKABLE void addCurrentTimeValues(QVariantMap values) const noexcept;
