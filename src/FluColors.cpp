...
# @File     : FluColors.cpp
# @Author   : jade
# @Date     : 2025/8/18 19:50
# @Email    : jadehh@1ive.com
# @Software : Samples
# @Desc     : FluColors.cpp
*/
//
#include "include/FluColors.h"
...
FluColors::FluColors(QObject *parent) : QObject{parent} {
    ...
    const auto yellow = new FluAccentColor(this);
    ...
    const auto orange = new FluAccentColor(this);
    ...
    const auto red = new FluAccentColor(this);
    ...
    const auto magenta = new FluAccentColor(this);
    ...
    const auto purple = new FluAccentColor(this);
    ...
    const auto blue = new FluAccentColor(this);
    ...
    const auto teal = new FluAccentColor(this);
    ...
    const auto green = new FluAccentColor(this);
...
[[maybe_unused]] FluAccentColor *FluColors::createAccentColor(const QColor &primaryColor) {
    const auto accentColor = new FluAccentColor(this);
