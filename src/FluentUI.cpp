...
void FluentUI::registerTypes(const char *uri) {
    ...
    constexpr int major = _major;
    constexpr int minor = _minor;
    //@uri FluentUI
...
void FluentUI::initializeEngine(const QQmlEngine *engine, [[maybe_unused]] const char *uri) {
    Q_UNUSED(engine)
}
