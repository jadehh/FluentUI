...
Grid::Grid(QCPGrid* grid, QCustomPlot *parentPlot, QObject *parent)
    : QObject(parent), m_parentPlot(parentPlot), m_qcpgrid(grid)
{
...
void Grid::set_visible(const bool value) noexcept
{
...
void Grid::set_subVisible(const bool value) noexcept
{
...
void Grid::set_lineWidth(const int value) noexcept
{
...
void Grid::set_subLineWidth(const int value) noexcept
{
